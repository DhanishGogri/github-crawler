...
function User() {
  ...
  // get data from @getUser() and stores it in the vars.
  const {
    name,
    type,
    avatar_url,
  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions ">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn hover:bg-primary bg-secondary"
                >
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-neutral-focus stats">
